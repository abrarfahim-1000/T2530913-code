...
> ### ⚠️ STATUS 2026-08-20 — HISTORICAL. Documents labelling for the RETIRED 4-class task.
>
> The `cascade` class, the class-balancing quotas, and the keep-probability tuning described here
> all belong to the 4-class classification target, **retired on 2026-08-16**. The datasets this
> journal produced were deleted on 2026-08-20.
>
> **Why it is still worth reading:** the methodology of getting a simulator to produce a
> particular labelled phenomenon — and the several ways that went wrong — transfers directly to
> the N-1 generation work, and the journal format makes the dead ends legible in a way a results
> table cannot. Treat it as a methods appendix, not as a description of the current dataset.
>
> Current dataset generation: [`study.md`](../study.md) §6 · N-1 label semantics in
> `data/grid_dataset_*_n1_meta.json`.
