...
> **START HERE (as of 2026-08-15).** Stage 1 is **done** — 2,463 candidates across 16 documents
> sit in `rules_35b/`. The polarity guard, the shield package, and the eval harness are **built and
> tested** (89 tests green); §3c items 1–2 are complete. Read **§3d** for the full-corpus
> measurements and what now exists in code, then **§4** for the commands to run on the research PC.
> Nothing downstream of translation has been run, because stages 2–3 need Ollama.
